...
#'StatMatrixSliceLabels$compute_panel(
#'  data = tibble(xc = 0, yc = 0,
#'                lx = 3, ly = 3, lz = 3,
#'                ix = 1, ixend = 1, iy = 1, iyend = 2, iz = 1, izend = 3), scales = NULL,
...
#'  geom_matrix_slice(data = tibble(),
#'                    mapping = aes(xc = 0, yc = 0,
#'                                  lx = 3, ly = 3, lz = 3,
...
StatMatrixSliceLabels = ggplot2::ggproto(

  `_class` = 'StatMatrixSliceLabels',
  `_inherit` = Stat,
    ...
    data %>%
      ...
      dplyr::group_modify(
        ~(function(dotx) {
          ...
          pts = NULL
          if ( combined ) {
            pts = pts_matrix_slice_combined_labels(
