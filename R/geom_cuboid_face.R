...
#'geom_cuboid_face(mapping = aes(xc = 0, yc = 0, lx = 2, ly = 1, lz = 0.5))
...
#' scale_x_continuous(limits = c(-2,2)) +
#' scale_y_continuous(limits = c(-2,2)) +
#' geom_cuboid_face(mapping = aes(xc = 0, yc = 0),degx = 0, degy = 0, degz = 0)
#'
#' # removing coord_equal() results in cuboid being deformed according to scale
#' ggplot() +
#' scale_x_continuous(limits = c(-2,2)) +
#' scale_y_continuous(limits = c(-2,2)) +
#' geom_cuboid_face(mapping = aes(xc = .5, yc = 0),degx = 70, degy = 20, degz = 0)
#'
